...
namespace BeautyHubAPI.Repository
{
    public class VendorRepository : IVendorRepository
    {
        ...
        public VendorRepository(IMapper mapper,
        ...
        public async Task<Object> buyServicePlan(buyMembershipPlanDTO model, string currentUserId)
        {
        ...
        public async Task<Object> DeleteSalonBanner(int salonBannerId)
        {
        ...
        public async Task<Object> GetSalonBannerDetail(int salonBannerId)
        {
            var getSalonBanner = await _context.SalonBanner.FirstOrDefaultAsync(u => u.SalonBannerId == salonBannerId);
        ...
        public async Task<Object> GetVendorAppointmentDetail(int appointmentId, string currentUserId)
        {
        ...
        public async Task<Object> SetAppointmentStatus(SetAppointmentStatusDTO model)
        {
        ...
        public async Task<Object> SetPaymentStatus(SetPaymentStatusDTO model)
        {
        ...
        public async Task<Object> MarkAppointmentAsRead(ReadStatusDTO model)
        {
            var appointmentDetail = await _context.Appointment.Where(u => u.AppointmentId == model.appointmentId).FirstOrDefaultAsync();
        ...
        public async Task<Object> UpComingSchedule(int salonId)
        {
        ...
        public async Task<Object> UpComingScheduleDetail(string queryDate)
        {
