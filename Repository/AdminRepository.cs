...
namespace BeautyHubAPI.Repository
{
    public class AdminRepository : IAdminRepository
    {
        ...
        public async Task<Object> GetSuperAdminDetail(string currentUserId)
        {
        ...
        public async Task<Object> GetPaymentOptions(int? membershipPlanId)
        {
        ...
        public async Task<Object> addUpdateMembershipPlan(MembershipPlanDTO model)
        {
        ...
        public async Task<Object> getMembershipPlanList(string? searchQuery, string? vendorId, int? planType)
        {
        ...
        public async Task<Object> getMembershipPlanDetail(int membershipPlanId)
        {
        ...
        public async Task<Object> deleteMembershipPlan(int membershipPlanId)
        {
            try
            {
        ...
        public async Task<Object> GetVendorDetail(string vendorId, string currentUserId)
        {
            var adminDetail = _userManager.FindByIdAsync(currentUserId).GetAwaiter().GetResult();
