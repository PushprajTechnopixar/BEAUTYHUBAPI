...
namespace BeautyHubAPI.Repository
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public async Task<Object> GetSalonList(string? salonQuery, string? salonType, string? searchBy, int? liveLocation, string currentUserId)
        {
            var userProfileDetail = await _context.UserDetail.Where(u => u.UserId == currentUserId).FirstOrDefaultAsync();
        ...
        public async Task<Object> GetFavouriteSalonList(string? salonType, string? searchBy, int? liveLocation, string currentUserId)
        {
        ...
        public async Task<Object> DeleteCustomerAddress(int customerAddressId, string currentUserId)
        {
        ...
        public async Task<Object> GetCustomerAddressDetail(int customerAddressId, string currentUserId)
        {
            var customerDetail = await _context.CustomerAddress.FirstOrDefaultAsync(u => (u.CustomerAddressId == customerAddressId));
        ...
        public async Task<Object> GetCustomerAddressList(string currentUserId)
        {
        ...
        public async Task<Object> DeleteCustomerAccount(string? customerUserId, string currentUserId)
        {
        ...
        public async Task<Object> GetServiceListFromCart(string? availableService, int? liveLocation, string currentUserId)
        {
            var userProfileDetail = await _context.UserDetail.Where(u => u.UserId == currentUserId).FirstOrDefaultAsync();
        ...
        public async Task<Object> RemoveServiceFromCart(int serviceId, int? slotId, string currentUserId)
        {
        ...
        public async Task<Object> CancelAppointment(CancelAppointmentDTO model, string currentUserId)
        {
            var userProfileDetail = await _context.UserDetail.Where(u => u.UserId == currentUserId).FirstOrDefaultAsync();
        ...
        public async Task<Object> GetServiceCountInCart(string currentUserId)
        {
            ...
            _response.StatusCode = HttpStatusCode.OK;
            _response.IsSuccess = true;
            _response.Data = new { totalCount = serviceCount, finalPrice = finalPrice };
            _response.Messages = "Total count and price shown successfully.";
            return _response;

        }
        public async Task<Object> GetUnavailableServices(int? liveLocation, string currentUserId)
        {
            var userProfileDetail = await _context.UserDetail.Where(u => u.UserId == currentUserId).FirstOrDefaultAsync();
        ...
        public async Task<Object> setFavouriteSalonStatus(SetFavouriteSalon model, string currentUserId)
        {
        ...
        public async Task<Object> BookAppointment(PlaceAppointmentRequestDTO model, string currentUserId)
        {
            string vendorId = "";
            int SalonId = 0;
        ...
        public async Task<Object> GetCustomerAppointmentDetail(int appointmentId, int? liveLocation, string currentUserId)
        {
            liveLocation = liveLocation != null ? liveLocation : 0;
            var userProfileDetail = await _context.UserDetail.Where(u => u.UserId == currentUserId).FirstOrDefaultAsync();
        ...
        public async Task<Object> SetFavouriteServiceStatus(SetFavouriteService model, string currentUserId)
        {
        ...
        public async Task<Object> GetFavouriteServiceList(int salonId, string currentUserId)
        {
            var userProfileDetail = await _context.UserDetail.Where(u => u.UserId == currentUserId).FirstOrDefaultAsync();
