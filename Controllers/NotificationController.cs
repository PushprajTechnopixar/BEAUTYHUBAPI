...
namespace BeautyHubAPI.Controllers
{
    ...
    public class NotificationController : ControllerBase
    {
        ...
        public NotificationController(ApplicationDbContext context, RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, IConfiguration config, IMapper mapper, IMobileMessagingClient mobileMessagingClient, INotificationRepository notificationRepository)
        {
            _context = context;
        ...
        public async Task<IActionResult> GetBroadcastNotificationList([FromQuery] int pageNumber, int pageSize, string? searchByRole, string? searchQuery)
        {
            try
            {
                ...
                //return Ok(_response);
                var response = await _notificationRepository.GetBroadcastNotificationList(pageNumber, pageSize, searchByRole, searchQuery, currentUserId);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> BroadcastNotification([FromBody] AddNotificationDTO model)
        {
            try
            {
                ...
                //return Ok(_response);
                var response = await _notificationRepository.BroadcastNotification(model, currentUserId);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> DeleteBroadcastNotification([FromQuery] int? notificationId)
        {
            try
            {
                ...
                //return Ok(_response);
                //}
                var response = await _notificationRepository.DeleteBroadcastNotification(notificationId, currentUserId);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetNotificationList([FromQuery] int pageNumber, int pageSize, string? searchQuery)
        {
            try
            {
                ...
                //_response.Messages = "Notification" + ResponseMessages.msgListFoundSuccess;
                //return Ok(_response);
                var response = await _notificationRepository.GetNotificationList(pageNumber, pageSize, searchQuery, currentUserId);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> ReadNotification(int? notificationSentId)
        {
            try
            {
                ...
                var response = await _notificationRepository.ReadNotification(notificationSentId, currentUserId);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> DeleteNotification([FromQuery] int? notificationSentId)
        {
            try
            {
                ...
                //return Ok(_response);
                //}
                var response = await _notificationRepository.DeleteNotification(notificationSentId, currentUserId);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> UpdateFCMToken(FCMTokenDTO model)
        {
            try
            {
                ...
                //return Ok(_response);
                //}
                var response = await _notificationRepository.UpdateFCMToken(model, currentUserId);
                return Ok(response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetNotificationCount()
        {
            try
            {
                ...
                var response = await _notificationRepository.GetNotificationCount(currentUserId);
                return Ok(response);
