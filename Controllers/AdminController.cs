...
namespace BeautyHubAPI.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPaymentOptions(int? membershipPlanId)
        {
            try
            {
                ...
                if (planDetail == null)
                {
                    _response.StatusCode = HttpStatusCode.OK;
                    _response.IsSuccess = false;
                    _response.Messages = "Not found any plan.";
                    return Ok(_response);
                }
                ...
                _response.Messages = "Payment option shown successfully.";
                return Ok(_response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> AddVendor([FromBody] AddVendorSalonDTO model)
        {
            ...
            _response.Messages = "Vendor detail added successfully.";
            return Ok(_response);
        }
        #endregion
        ...
        public async Task<IActionResult> UpdateVendor([FromBody] UpdateVendorSalonDTO model)
        {
            ...
            _response.IsSuccess = true;
            _response.Data = vendorDetail;
            _response.Messages = "Vendor detail updated successfully.";
            return Ok(_response);
        }
        #endregion
        ...
        public async Task<IActionResult> DeleteVendor([FromQuery] string VendorId)
        {
            ...
            _response.StatusCode = HttpStatusCode.OK;
            _response.IsSuccess = true;
            _response.Messages = "Deleted successfully.";
            return Ok(_response);
        }
        #endregion
